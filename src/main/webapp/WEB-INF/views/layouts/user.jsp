			...
			<div class="container">
				<div class="alignR">
					...
					<c:if test="${ not empty LoginInfo }">
						<a href="<c:url value="/gio-hang" />"><span class="icon-user"></span>
							${ LoginInfo.display_name }</a>
						<a href="<c:url value="/dang-xuat" />"><span class="icon-user"></span>
							Đăng xuất</a>
					</c:if>
...
-->
	...
	<div class="copyright">
		<div class="container">
			...
			<span>Copyright &copy; 2013<br> Trang thương mại điện tử
