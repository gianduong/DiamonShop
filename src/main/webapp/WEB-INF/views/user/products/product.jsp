			...
			<div class="well well-small">
				...
				<ul id="productDetail" class="nav nav-tabs">
					...
					<li class="dropdown"><a href="#" class="dropdown-toggle"
						data-toggle="dropdown">Phụ kiện đi kèm <b class="caret"></b></a>
						<ul class="dropdown-menu">
							<li><a href="#cat1" data-toggle="tab">Thể loại: one</a></li>
							<li><a href="#cat2" data-toggle="tab">Thể loại: two</a></li>
						</ul></li>
				</ul>
